...
def classify(task:str):
    ...
    if descriptive: level,debate,human="simple",False,False
        ...
        local_complex_test=(has_any(text,("tester une ","tester le ","tester ","construire")) and has_any(text,OBJECTS) and has_any(text,("sans déployer","sans la déployer","sans l'appliquer","sans appliquer","sans toucher")))
