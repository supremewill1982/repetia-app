...
<Stack.Screen name="ProfilRepetiteur" component={ProfilRepetiteurScreen} options={{title:'Mon Profil'}}/><Stack.Screen name="RatingsList" component={RatingsListScreen} options={{title:'Mes Avis'}}/><Stack.Screen name="ContribuerCours" component={ContribuerCoursScreen} options={{title:'Contribuer un cours'}}/><Stack.Screen name="MesCours" component={MesCoursScreen} options={{title:'Mes Contributions'}}/><Stack.Screen name="Certification" component={CertificationScreen} options={{title:'Certification'}}/><Stack.Screen name="TestCertification" component={TestCertificationScreen} options={{title:'Test de certification'}}/><Stack.Screen name="TestValidation" component={TestValidationScreen} options={{title:'Test de validation'}}/><Stack.Screen name="TuteurDashboard" component={TuteurDashboardScreen} options={{title:'Tableau de bord'}}/><Stack.Screen name="InscriptionTuteur" component={InscriptionTuteurScreen} options={{title:'Devenir répétiteur'}}/><Stack.Screen name="Reclamation" component={ReclamationScreen} options={{title:'Réclamation'}}/><Stack.Screen name="EditContribution" component={EditContributionScreen} options={{title:'Modifier la contribution'}}/><Stack.Screen name="ContributionDetails" component={ContributionDetailsScreen} options={{title:'Détails du cours'}}/><Stack.Screen name="DemanderPaiement" component={DemanderPaiementScreen} options={{title:'Paiement'}}/><Stack.Screen name="MesReservationsTuteur" component={MesReservationsTuteurScreen} options={{title:'Mes réservations'}}/>
</Stack.Navigator>}
