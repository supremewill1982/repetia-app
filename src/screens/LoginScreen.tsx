    ...
    >
      <View style={[styles.innerContainer, { backgroundColor: colors.surface }]}>
        <View style={styles.logoContainer}>
          ...
          <Text style={[styles.logoSubtitle, { color: colors.textMuted }]}>Plateforme d'apprentissage</Text>
        </View>
        ...
        <View style={styles.formContainer}>
          ...
          <TouchableOpacity style={[styles.forgotButton, { backgroundColor: colors.surface }]} onPress={() => navigation.navigate('ForgotPassword')}>
          ...
          <View style={styles.signupContainer}>
            <Text style={[styles.signupText, { color: colors.textMuted }]}>Vous n'avez pas de compte ?</Text>
            <TouchableOpacity onPress={() => navigation.navigate('Register', selectedRole ? { selectedRole } : undefined)}>
          ...
          >
            ...
            <Text style={[styles.roleButtonText, { color: colors.primary }]}>Choisir un autre rôle</Text>
          </TouchableOpacity>
        </View>
      </View>
    </KeyboardAvoidingView>
...
const styles = StyleSheet.create({
  ...
  inputContainer: { flexDirection: 'row', alignItems: 'center', padding: 12, borderRadius: 8, borderWidth: 1, marginBottom: 16 },
  input: { flex: 1, marginLeft: 8, fontSize: 14 },
  forgotButton: { alignSelf: 'flex-end', padding: 8 },
  forgotText: { fontSize: 12, fontWeight: '500' },
  loginButton: { padding: 16, borderRadius: 8, alignItems: 'center', marginTop: 24 },
  ...
  roleButton: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', padding: 12, borderRadius: 8, borderWidth: 1, marginTop: 24 },
  roleButtonText: { marginLeft: 8, fontWeight: '500' },
});
