...
export default function ContribuerCoursScreen({ navigation }: any) {
  ...
  const pickDocument = async () => {
    try {
      ...
      Alert.alert('Erreur','Impossible de sélectionner le fichier. Vérifiez l’autorisation d’accès aux fichiers.');
    }
  };
